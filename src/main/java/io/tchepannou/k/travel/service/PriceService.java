...
public class PriceService {
    ...
    public GetPriceResponse findById(Integer id){
        ...
        final io.tchepannou.k.travel.client.response.PriceType priceTypeDto = toPriceTypeDto(priceType);
    ...
    public GetProductPricesResponse findByProductId (Integer productId){
        ...
        final Map<Integer, io.tchepannou.k.travel.client.response.PriceType> priceTypeDtoMap = toPriceTypeDtoMap(prices);
    ...
    private Map<Integer, io.tchepannou.k.travel.client.response.PriceType> toPriceTypeDtoMap(List<Price> prices){
        ...
        final List<io.tchepannou.k.travel.client.response.PriceType> priceTypeDtos = priceTypes.stream()
    ...
    private io.tchepannou.k.travel.client.response.PriceType toPriceTypeDto (final PriceType priceType){
        final io.tchepannou.k.travel.client.response.PriceType dto = new io.tchepannou.k.travel.client.response.PriceType();
    ...
    private io.tchepannou.k.travel.client.response.Price toPriceDto (final Price price, final io.tchepannou.k.travel.client.response.PriceType priceType){
        final io.tchepannou.k.travel.client.response.Price dto = new io.tchepannou.k.travel.client.response.Price();
